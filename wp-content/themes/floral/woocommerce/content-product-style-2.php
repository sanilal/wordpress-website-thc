...
<article id="product-<?php the_ID(); ?>" <?php post_class($has_rating); ?>>
	...
	<div class="product-inner">
		<div class="product-thumbnail">
			 ...
			 */
			remove_action( 'woocommerce_before_shop_loop_item_title', array('Floral_Woocommerce', 'template_secondary_image_on_hover'), 13 );
			remove_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_thumbnail', 10 );
			remove_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash', 10 );
			woocommerce_show_product_loop_sale_flash();
			Floral_Woocommerce::get_custom_size_thumbnail(true, '370x246');
			Floral_Woocommerce::template_secondary_image_on_hover(true, '370x246');
