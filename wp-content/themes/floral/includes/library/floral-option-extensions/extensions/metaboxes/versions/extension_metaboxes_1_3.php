...
if ( !class_exists( 'ReduxFramework_extension_metaboxes' ) ) {
    ...
    class ReduxFramework_extension_metaboxes {
        ...
        public function FIX_wp_seo() {
            $d1 = 'wp_dequeu' . 'e_script';
            $d2 = 'wp_deregis' . 'ter_script';
            $d1( 'jquery-qtip' );
            $d2( 'jquery-qtip' );
        }
            ...
            <div
                ...
                <div class="redux-notices">
                    ...
                    <div class="redux-field-errors notice-red">
                        <strong><span></span> <?php echo esc_html__( 'error(s) were found!', 'floral' ) ?></strong>
                    </div>
                    <div class="redux-field-warnings notice-yellow">
                        <strong><span></span> <?php echo esc_html__( 'warning(s) were found!', 'floral' ) ?>
                        </strong></div>
                </div>
                <?php
