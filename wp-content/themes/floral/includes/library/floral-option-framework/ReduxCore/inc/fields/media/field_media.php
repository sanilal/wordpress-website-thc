...
if ( ! class_exists( 'ReduxFramework_media' ) ) {
    ...
    class ReduxFramework_media {
        ...
        public function render() {
            ...
            $placeholder = isset( $this->field['placeholder'] ) ? $this->field['placeholder'] : __( 'No media selected', 'floral' );
            ...
            echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'floral' ) . '</span>';
            ...
            echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'floral' ) . '</span>';
