     ...
     */
        ...
        <span class="at-re-toggle"><img src="';
                    if ( $this->_Local_images ) {
                        echo sprintf( '%s', $plugin_path . '/images/edit.png' );
                    } else {
        ...
        <img src="';
                    if ( $this->_Local_images ) {
                        echo sprintf( '%s', $plugin_path . '/images/remove.png' );
                    } else {
                        echo 'http://i.imgur.com/g8Duj.png';
                    }
                    echo '" alt="' . esc_html__( 'Remove', 'floral' ) . '" title="' . esc_html__( 'Remove', 'floral' ) . '" id="remove-' . $field['id'] . '"></div>';
                    $c = $c + 1;
            ...
            echo '<img src="';
            if ( $this->_Local_images ) {
                echo sprintf( '%s', $plugin_path . '/images/add.png' );
            } else {
                echo 'http://i.imgur.com/w5Tuc.png';
            }
            echo '" alt="' . esc_html__( 'Add', 'floral' ) . '" title="' . esc_html__( 'Add', 'floral' ) . '" id="add-' . $field['id'] . '"><br/></div>';
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
        ...
        public function show_field_image( $field, $meta ) {
            ...
            echo "<input type='hidden' name='{$name}[url]' value='{$value['url']}'/>";
            if ( $has_image ) {
                echo "<input class='{$multiple} button  simplePanelimageUploadclear' id='{$id}' value='" . esc_html__( 'Remove Image', 'floral' ) . "' type='button'/>";
            } else {
                echo "<input class='{$multiple} button simplePanelimageUpload' id='{$id}' value='" . esc_html__( 'Upload Image', 'floral' ) . "' type='button'/>";
            }
            $this->show_field_end( $field, $meta );
        }
