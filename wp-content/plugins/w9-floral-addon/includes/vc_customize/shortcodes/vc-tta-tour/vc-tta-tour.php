...
vc_map( array(
    'name'                    => __( 'Tour', 'w9-floral-addon' ),
    'base'                    => 'vc_tta_tour',
    'icon'                    => 'w9 w9-ico-arrows-glide-horizontal',
    'is_container'            => true,
    ...
    'description'             => __( 'Vertical tabbed content', 'w9-floral-addon' ),
    'params'                  => array(
        array(
            'type'        => 'textfield',
            'param_name'  => 'title',
        ...
        array(
            ...
            'param_name'  => 'style',
            'value'       => array(
                __( 'Spring version', 'w9-floral-addon' ) => 'springv',
            ...
            'description' => __( 'Select tour display style.', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'dropdown',
            'param_name'  => 'shape',
            ...
            'description' => __( 'Select tour shape.', 'w9-floral-addon' ),
            'dependency'  => array(
                'element'            => 'style',
        ...
        array(
            ...
            'description'        => __( 'Select tour color.', 'w9-floral-addon' ),
        ...
        array(
            ...
            'description' => __( 'Select tour spacing.', 'w9-floral-addon' ),
            'std'         => '1',
        ),
        array(
            'type'        => 'dropdown',
            ...
            'description' => __( 'Select tour gap.', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'dropdown',
            ...
            'description' => __( 'Select tour navigation position.', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'dropdown',
            ...
            'description' => __( 'Select tour section title alignment.', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'dropdown',
            'param_name'  => 'controls_size',
            'value'       => array(
                __( 'Auto', 'w9-floral-addon' )        => '',
                __( 'Extra large', 'w9-floral-addon' ) => 'xl',
                __( 'Large', 'w9-floral-addon' )       => 'lg',
                __( 'Medium', 'w9-floral-addon' )      => 'md',
                __( 'Small', 'w9-floral-addon' )       => 'sm',
                __( 'Extra small', 'w9-floral-addon' ) => 'xs',
            ),
            'heading'     => __( 'Navigation width', 'w9-floral-addon' ),
            'description' => __( 'Select tour navigation width.', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'dropdown',
            'param_name'  => 'autoplay',
            ...
            'description' => __( 'Select auto rotate for tour in seconds (Note: disabled by default).', 'w9-floral-addon' ),
        ),
        array(
            'type'        => 'textfield',
