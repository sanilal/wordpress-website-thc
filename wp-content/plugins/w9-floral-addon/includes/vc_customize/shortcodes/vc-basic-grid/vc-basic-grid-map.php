 ...
 * @filename: vc-basic-grid-map.php
...
$gridParams = Floral_Grids_Common::getBasicAtts();
vc_map( array(
    'name'           => __( 'Floral Posts', 'w9-floral-addon' ),
    'base'           => Floral_SC_Basic_Grid::SC_BASE,
    'icon'           => 'w9 w9-ico-software-layout-header-2columns',
    'category'       => __( 'Content', 'w9-floral-addon' ),
    'description'    => __( 'Posts, pages or custom posts in grid', 'w9-floral-addon' ),
    'php_class_name' => 'Floral_SC_Basic_Grid',
    'params'         => $gridParams,
) );
