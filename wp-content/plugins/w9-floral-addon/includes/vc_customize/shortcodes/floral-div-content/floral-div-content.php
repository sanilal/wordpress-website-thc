 ...
 * @filename: floral-div-content.php
...
class Floral_SC_Div_Content extends WPBakeryShortCodesContainer {
    const SC_BASE = 'floral_shortcode_div_content';
    /**
     * @param        $controls
    ...
    public function getColumnControls( $controls = 'full', $extended_css = '' ) {
        $controls_start = '<div class="vc_controls vc_controls-visible controls_column floral-div-content-controls ' . ( !empty( $extended_css ) ? " {$extended_css}" : '' ) . '">';
        $controls_end   = '</div>';
