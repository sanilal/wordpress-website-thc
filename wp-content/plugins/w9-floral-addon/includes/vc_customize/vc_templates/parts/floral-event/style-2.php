...
//echo $order;
if ( ( $order % 2 ) === 0 ) {
	$class_event_item['order'] = 'style-even';
} elseif ( ( $order % 2 ) === 1 ) {
	$class_event_item['order'] = 'style-odd';
}
...
<div class="event-item <?php floral_the_clean_html_classes( $class_event_item ) ?>">
	...
	<div class="event-item-inner">
		<div class="item-image" style="background-image: url(<?php echo Floral_Image::get_resize_image_url( get_post_thumbnail_id( $item_id ), $event_image_size ); ?>);"></div>
